...
function Home() {
    ...
    return (
        <div className='flex flex-col min-h-screen overflow-hidden'>
            {/* Hero Section */}
            <section id='hero' className='flex flex-col items-center justify-center min-h-screen text-center px-4 pt-16 relative'>
                ...
                >
                    ...
                    <motion.div variants={fadeInUp} className='text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto'>
                    ...
                    <motion.div variants={fadeInUp} className='flex gap-4 justify-center'>
                        <Link to="/projects" className='px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-full font-semibold transition-all transform hover:scale-105 shadow-lg shadow-blue-500/30'>
                            View Projects
                        </Link>
                        <Link to="/contact" className='px-8 py-3 border border-blue-500 hover:bg-blue-500/10 rounded-full font-semibold transition-all hover:shadow-lg hover:shadow-blue-500/20'>
                            Contact Me
                        </Link>
                    </motion.div>
                </motion.div>
            ...
            >
                <div className='max-w-4xl mx-auto text-center'>
                    ...
                    <Link to="/about" className='text-blue-400 hover:text-blue-300 font-semibold hover:underline inline-flex items-center gap-2 group'>
                        Read More About Me
            ...
            <section className='py-20 px-4'>
                <div className='max-w-6xl mx-auto'>
                    ...
                    <div className='text-center mt-10'>
                        <Link to="/skills" className='text-blue-400 hover:text-blue-300 font-semibold hover:underline inline-flex items-center gap-2 group'>
                            View All Skills
                            <span className="group-hover:translate-x-1 transition-transform">&rarr;</span>
                        </Link>
                    </div>
